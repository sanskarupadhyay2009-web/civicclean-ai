...
function ReportWaste() {
  ...
  const handleDetectLocation = () => {
    ...
    navigator.geolocation.getCurrentPosition(
      ...
      () => {
        setError("Unable to detect location. You can still submit without it.");
        setLocating(false);
      }
    );
  };
  ...
  return (
    <main className="report-page">
      ...
      >
        ...
        {location ? (
          <p>
            Detected: {location.latitude.toFixed(5)}, {location.longitude.toFixed(5)}
          </p>
        ) : (
          <p>Location picker will be connected later.</p>
        )}
